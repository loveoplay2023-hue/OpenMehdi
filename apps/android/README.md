## OpenMehdi Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_openmehdi-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm openmehdi gateway --port 18789 --verbose
```

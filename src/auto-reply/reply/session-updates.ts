...
export async function prependSystemEvents(params: {
  ...
  const resolveSystemEventTimezone = (cfg: OpenMehdiConfig) => {
  ...
  const formatSystemEventTimestamp = (ts: number, cfg: OpenMehdiConfig) => {
...
export async function ensureSkillSnapshot(params: {
  ...
  if (process.env.OPENMEHDI_TEST_FAST === "1") {

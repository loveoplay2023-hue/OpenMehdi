...
function resolveMentionPatterns(cfg: OpenMehdiConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: OpenMehdiConfig | undefined, agentId?: string): RegExp[] {

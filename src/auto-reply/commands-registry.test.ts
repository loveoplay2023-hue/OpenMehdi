...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@openmehdi", { botUsername: "openmehdi" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@openmehdi args", {
        botUsername: "openmehdi",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@openmehdi: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "openmehdi" })).toBe(
      "/help@otherbot",
    );
  });

...
function resolveWatchPaths(workspaceDir: string, config?: OpenMehdiConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: OpenMehdiConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenMehdiConfig }) {

...
function makeCfg(overrides: Partial<OpenMehdiConfig> = {}): OpenMehdiConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeFallbacksOnlyCfg(): OpenMehdiConfig {
  return {
    agents: {
      defaults: {
        model: {
...
function makeProviderFallbackCfg(provider: string): OpenMehdiConfig {
  return makeCfg({
    agents: {
      defaults: {
        model: {

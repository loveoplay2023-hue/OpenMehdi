...
export const DEFAULT_SANDBOX_IMAGE = "openmehdi-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "openmehdi-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "openmehdi-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "openmehdi-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "openmehdi-sbx-browser-";

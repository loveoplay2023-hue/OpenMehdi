...
export function resolveModel(
  ...
  const resolvedAgentDir = agentDir ?? resolveOpenMehdiAgentDir();
 ...
 * a hint.
 *
 * See: https://github.com/openmehdi/openmehdi/issues/17328
 */
const LOCAL_PROVIDER_HINTS: Record<string, string> = {
  ollama:
    "Ollama requires authentication to be registered as a provider. " +
    'Set OLLAMA_API_KEY="ollama-local" (any value works) or run "openmehdi configure". ' +
    "See: https://docs.openmehdi.ai/providers/ollama",
  vllm:
    "vLLM requires authentication to be registered as a provider. " +
    'Set VLLM_API_KEY (any value works) or run "openmehdi configure". ' +
    "See: https://docs.openmehdi.ai/providers/vllm",
};

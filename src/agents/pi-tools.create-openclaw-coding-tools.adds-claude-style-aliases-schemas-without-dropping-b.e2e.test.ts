...
describe("createOpenMehdiCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createOpenMehdiCodingTools({
      config,
    ...
    const anthropicTools = createOpenMehdiCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createOpenMehdiCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createOpenMehdiCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });

...
const CLEANUP_STATE_KEY = Symbol.for("openmehdi.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("openmehdi.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("openmehdi.sessionWriteLockWatchdogState");

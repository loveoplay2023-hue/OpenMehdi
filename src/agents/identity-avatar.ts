...
function resolveAvatarSource(cfg: OpenMehdiConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenMehdiConfig, agentId: string): AgentAvatarResolution {

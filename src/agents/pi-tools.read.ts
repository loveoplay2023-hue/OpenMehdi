...
function resolveAdaptiveReadMaxBytes(options?: OpenMehdiReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createOpenMehdiReadTool(base, {
...
export function createOpenMehdiReadTool(
  base: AnyAgentTool,
  options?: OpenMehdiReadToolOptions,
): AnyAgentTool {

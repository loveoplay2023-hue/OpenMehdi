...
/**
 * Convert an OpenMehdi auth-profiles credential to pi-coding-agent auth.json format.
 ...
 *
 * OpenMehdi stores credentials in auth-profiles.json instead. This helper

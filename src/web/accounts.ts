...
export function listWhatsAppAuthDirs(cfg: OpenMehdiConfig): string[] {
...
export function hasAnyWhatsAppAuth(cfg: OpenMehdiConfig): boolean {
...
export function resolveWhatsAppAuthDir(params: { cfg: OpenMehdiConfig; accountId: string }): {
  authDir: string;
  isLegacy: boolean;
} {
...
export function listEnabledWhatsAppAccounts(cfg: OpenMehdiConfig): ResolvedWhatsAppAccount[] {

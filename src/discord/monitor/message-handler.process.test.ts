...
const resolveStorePath = vi.fn(() => "/tmp/openmehdi-discord-process-test-sessions.json");
...
beforeEach(() => {
  ...
  resolveStorePath.mockReturnValue("/tmp/openmehdi-discord-process-test-sessions.json");
});

...
function mergeDiscordAccountConfig(cfg: OpenMehdiConfig, accountId: string): DiscordAccountConfig {
...
export function listEnabledDiscordAccounts(cfg: OpenMehdiConfig): ResolvedDiscordAccount[] {

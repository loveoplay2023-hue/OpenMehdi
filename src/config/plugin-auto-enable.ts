...
function isTelegramConfigured(cfg: OpenMehdiConfig, env: NodeJS.ProcessEnv): boolean {
...
function isDiscordConfigured(cfg: OpenMehdiConfig, env: NodeJS.ProcessEnv): boolean {
...
function isIrcConfigured(cfg: OpenMehdiConfig, env: NodeJS.ProcessEnv): boolean {
...
function isSlackConfigured(cfg: OpenMehdiConfig, env: NodeJS.ProcessEnv): boolean {
  if (
...
function isSignalConfigured(cfg: OpenMehdiConfig): boolean {
...
function isIMessageConfigured(cfg: OpenMehdiConfig): boolean {
...
function isWhatsAppConfigured(cfg: OpenMehdiConfig): boolean {
...
function isGenericChannelConfigured(cfg: OpenMehdiConfig, channelId: string): boolean {
...
function collectModelRefs(cfg: OpenMehdiConfig): string[] {
  const refs: string[] = [];
...
function isProviderConfigured(cfg: OpenMehdiConfig, providerId: string): boolean {
...
function isPluginExplicitlyDisabled(cfg: OpenMehdiConfig, pluginId: string): boolean {
  const entry = cfg.plugins?.entries?.[pluginId];
  return entry?.enabled === false;
}

function isPluginDenied(cfg: OpenMehdiConfig, pluginId: string): boolean {
...
function registerPluginEntry(cfg: OpenMehdiConfig, pluginId: string): OpenMehdiConfig {
  const entries = {
    ...cfg.plugins?.entries,
    [pluginId]: {

...
function resolveAnthropicDefaultAuthMode(cfg: OpenMehdiConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: OpenMehdiConfig): OpenMehdiConfig {
...
export function applyTalkApiKey(config: OpenMehdiConfig): OpenMehdiConfig {
...
export function applyModelDefaults(cfg: OpenMehdiConfig): OpenMehdiConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: OpenMehdiConfig): OpenMehdiConfig {
...
export function applyLoggingDefaults(cfg: OpenMehdiConfig): OpenMehdiConfig {
...
export function applyContextPruningDefaults(cfg: OpenMehdiConfig): OpenMehdiConfig {
...
export function applyCompactionDefaults(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }

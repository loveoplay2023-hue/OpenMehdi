...
describe("tts", () => {
  ...
  describe("maybeApplyTtsToPayload", () => {
    ...
    const withMockedAutoTtsFetch = async (
      ...
      const prevPrefs = process.env.OPENMEHDI_TTS_PREFS;
      process.env.OPENMEHDI_TTS_PREFS = `/tmp/tts-test-${Date.now()}.json`;
      ...
      try {
        ...
        process.env.OPENMEHDI_TTS_PREFS = prevPrefs;
      }
    };

    const taggedCfg: OpenMehdiConfig = {
      ...baseCfg,
      messages: {
        ...baseCfg.messages!,

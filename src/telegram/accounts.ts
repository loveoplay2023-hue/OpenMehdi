...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.OPENMEHDI_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: OpenMehdiConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: OpenMehdiConfig): string {
...
function mergeTelegramAccountConfig(cfg: OpenMehdiConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: OpenMehdiConfig): ResolvedTelegramAccount[] {

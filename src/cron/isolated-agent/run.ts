...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/openmehdi/openmehdi/issues/15692
   */
  delivered?: boolean;
} & CronRunOutcome &
  CronRunTelemetry;
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.OPENMEHDI_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.openmehdi/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: OpenMehdiConfig = {
    ...params.cfg,

...
describe("formatPluginSourceForTable", () => {
  it("shortens bundled plugin sources under the stock root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "bundled",
        source: "/opt/homebrew/lib/node_modules/openmehdi/extensions/bluebubbles/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openmehdi/extensions",
        global: "/Users/x/.openmehdi/extensions",
        workspace: "/Users/x/ws/.openmehdi/extensions",
      },
    );
  ...
  it("shortens workspace plugin sources under the workspace root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "workspace",
        source: "/Users/x/ws/.openmehdi/extensions/matrix/index.ts",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openmehdi/extensions",
        global: "/Users/x/.openmehdi/extensions",
  ...
  it("shortens global plugin sources under the global root", () => {
    const out = formatPluginSourceForTable(
      {
        origin: "global",
        source: "/Users/x/.openmehdi/extensions/zalo/index.js",
      },
      {
        stock: "/opt/homebrew/lib/node_modules/openmehdi/extensions",
        global: "/Users/x/.openmehdi/extensions",

...
export const normalizePluginsConfig = (
  config?: OpenMehdiConfig["plugins"],
...
const hasExplicitMemorySlot = (plugins?: OpenMehdiConfig["plugins"]) =>
  Boolean(plugins?.slots && Object.prototype.hasOwnProperty.call(plugins.slots, "memory"));

const hasExplicitMemoryEntry = (plugins?: OpenMehdiConfig["plugins"]) =>
  Boolean(plugins?.entries && Object.prototype.hasOwnProperty.call(plugins.entries, "memory-core"));

const hasExplicitPluginConfig = (plugins?: OpenMehdiConfig["plugins"]) => {
  if (!plugins) {
    return false;
  }

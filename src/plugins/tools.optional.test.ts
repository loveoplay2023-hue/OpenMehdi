...
const loadOpenMehdiPluginsMock = vi.fn();

vi.mock("./loader.js", () => ({
  loadOpenMehdiPlugins: (params: unknown) => loadOpenMehdiPluginsMock(params),
}));
...
function setRegistry(entries: MockRegistryToolEntry[]) {
  ...
  loadOpenMehdiPluginsMock.mockReturnValue(registry);
  return registry;
}

describe("resolvePluginTools optional tools", () => {
  beforeEach(() => {
    loadOpenMehdiPluginsMock.mockReset();
  });

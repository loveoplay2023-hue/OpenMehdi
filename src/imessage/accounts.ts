...
function mergeIMessageAccountConfig(cfg: OpenMehdiConfig, accountId: string): IMessageAccountConfig {
...
export function listEnabledIMessageAccounts(cfg: OpenMehdiConfig): ResolvedIMessageAccount[] {

...
export type ChannelAgentToolFactory = (params: { cfg?: OpenMehdiConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: OpenMehdiConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: OpenMehdiConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: OpenMehdiConfig }) => boolean;
  supportsCards?: (params: { cfg: OpenMehdiConfig }) => boolean;

...
export function listChannelMessageActions(cfg: OpenMehdiConfig): ChannelMessageActionName[] {
...
export function supportsChannelMessageButtons(cfg: OpenMehdiConfig): boolean {
  for (const plugin of listChannelPlugins()) {
...
export function supportsChannelMessageCards(cfg: OpenMehdiConfig): boolean {
  for (const plugin of listChannelPlugins()) {

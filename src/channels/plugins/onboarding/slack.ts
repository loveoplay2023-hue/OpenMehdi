...
function setSlackDmPolicy(cfg: OpenMehdiConfig, dmPolicy: DmPolicy) {
...
function buildSlackManifest(botName: string) {
  const safeName = botName.trim() || "OpenMehdi";
  const manifest = {
    display_information: {
      name: safeName,
      description: `${safeName} connector for OpenMehdi`,
    },
    features: {
      bot_user: {
...
function setSlackAllowFrom(cfg: OpenMehdiConfig, allowFrom: string[]): OpenMehdiConfig {
  return {
    ...cfg,
    channels: {
      ...cfg.channels,

...
export const A2UI_PATH = "/__openmehdi__/a2ui";

export const CANVAS_HOST_PATH = "/__openmehdi__/canvas";

export const CANVAS_WS_PATH = "/__openmehdi__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.openmehdiCanvasA2UIAction.postMessage(...)
  // - Android: window.openmehdiCanvasA2UIAction.postMessage(...)
  const handlerNames = ["openmehdiCanvasA2UIAction"];
  ...
  globalThis.OpenMehdi = globalThis.OpenMehdi ?? {};
  globalThis.OpenMehdi.postMessage = postToNode;
  globalThis.OpenMehdi.sendUserAction = sendUserAction;
  globalThis.openmehdiPostMessage = postToNode;
  globalThis.openmehdiSendUserAction = sendUserAction;

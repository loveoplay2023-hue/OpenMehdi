    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["openmehdi channels list", "List configured channels and auth profiles."],
          ["openmehdi channels status --probe", "Run channel status checks and probes."],
          [
            "openmehdi channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["openmehdi channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.openmehdi.ai/cli/channels",
        )}\n`,
    );

...
const SANDBOX_EXAMPLES = {
  main: [
    ["openmehdi sandbox list", "List all sandbox containers."],
    ["openmehdi sandbox list --browser", "List only browser containers."],
    ["openmehdi sandbox recreate --all", "Recreate all containers."],
    ["openmehdi sandbox recreate --session main", "Recreate a specific session."],
    ["openmehdi sandbox recreate --agent mybot", "Recreate agent containers."],
    ["openmehdi sandbox explain", "Explain effective sandbox config."],
  ],
  list: [
    ["openmehdi sandbox list", "List all sandbox containers."],
    ["openmehdi sandbox list --browser", "List only browser containers."],
  ...
  recreate: [
    ["openmehdi sandbox recreate --all", "Recreate all containers."],
    ["openmehdi sandbox recreate --session main", "Recreate a specific session."],
    ["openmehdi sandbox recreate --agent mybot", "Recreate a specific agent (includes sub-agents)."],
    ["openmehdi sandbox recreate --browser --all", "Recreate only browser containers."],
    ["openmehdi sandbox recreate --all --force", "Skip confirmation."],
  ],
  explain: [
    ["openmehdi sandbox explain", "Show effective sandbox config."],
    ["openmehdi sandbox explain --session agent:main:main", "Explain a specific session."],
    ["openmehdi sandbox explain --agent work", "Explain an agent sandbox."],
    ["openmehdi sandbox explain --json", "JSON output."],
  ],
} as const;
...
export function registerSandboxCli(program: Command) {
  const sandbox = program
    ...
    .addHelpText(
      "after",
      () =>
        `\n${theme.muted("Docs:")} ${formatDocsLink("/cli/sandbox", "docs.openmehdi.ai/cli/sandbox")}\n`,
    )
    .action(() => {

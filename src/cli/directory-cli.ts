    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["openmehdi directory self --channel slack", "Show the connected account identity."],
          [
            'openmehdi directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["openmehdi directory groups list --channel discord", "List available groups/channels."],
          [
            "openmehdi directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.openmehdi.ai/cli/directory",
        )}\n`,
    )
    .action(() => {

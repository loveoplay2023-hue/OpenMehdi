      ...
      .addHelpText(
        ...
        () =>
          `\n${theme.heading("Examples:")}\n${formatHelpExamples([
            ["openmehdi gateway run", "Run the gateway in the foreground."],
            ["openmehdi gateway status", "Show service status and probe reachability."],
            ["openmehdi gateway discover", "Find local and wide-area gateway beacons."],
            ["openmehdi gateway call health", "Call a gateway RPC method directly."],
          ])}\n\n${theme.muted("Docs:")} ${formatDocsLink("/cli/gateway", "docs.openmehdi.ai/cli/gateway")}\n`,
      ),
  );

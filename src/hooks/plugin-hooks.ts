...
import type { OpenMehdiPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: OpenMehdiPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: OpenMehdiPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,

...
describe("loader", () => {
  ...
  beforeAll(async () => {
    fixtureRoot = await fs.mkdtemp(path.join(os.tmpdir(), "openmehdi-hooks-loader-"));
  });
  ...
  beforeEach(async () => {
    ...
    originalBundledDir = process.env.OPENMEHDI_BUNDLED_HOOKS_DIR;
    process.env.OPENMEHDI_BUNDLED_HOOKS_DIR = "/nonexistent/bundled/hooks";
  });
  ...
  afterEach(async () => {
    ...
    if (originalBundledDir === undefined) {
      delete process.env.OPENMEHDI_BUNDLED_HOOKS_DIR;
    } else {
      process.env.OPENMEHDI_BUNDLED_HOOKS_DIR = originalBundledDir;
    }
  });

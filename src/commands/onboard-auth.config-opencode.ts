...
export function applyOpencodeZenProviderConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
...
export function applyOpencodeZenConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {

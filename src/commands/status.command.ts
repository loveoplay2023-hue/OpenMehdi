...
export async function statusCommand(
  ...
  runtime.log(theme.heading("OpenMehdi status"));
  runtime.log("");
  ...
  runtime.log(theme.muted(`Full report: ${formatCliCommand("openmehdi security audit")}`));
  runtime.log(theme.muted(`Deep probe: ${formatCliCommand("openmehdi security audit --deep")}`));
  ...
  runtime.log("");
  runtime.log("FAQ: https://docs.openmehdi.ai/faq");
  runtime.log("Troubleshooting: https://docs.openmehdi.ai/troubleshooting");
  runtime.log("");
  ...
  runtime.log(`  Need to share?      ${formatCliCommand("openmehdi status --all")}`);
  runtime.log(`  Need to debug live? ${formatCliCommand("openmehdi logs --follow")}`);
  if (gatewayReachable) {
    runtime.log(`  Need to test channels? ${formatCliCommand("openmehdi status --deep")}`);
  } else {
    runtime.log(`  Fix reachability first: ${formatCliCommand("openmehdi gateway probe")}`);
  }
}

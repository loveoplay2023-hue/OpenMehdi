...
export function applyVercelAiGatewayProviderConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
...
export function applyVercelAiGatewayConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {

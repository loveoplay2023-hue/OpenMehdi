...
export function applyOpenrouterProviderConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: OpenMehdiConfig): OpenMehdiConfig {
...
export function applyMoonshotConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
...
export function applyQianfanProviderConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: OpenMehdiConfig): OpenMehdiConfig {

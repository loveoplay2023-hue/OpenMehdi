...
describe("writeOAuthCredentials", () => {
  ...
  it("writes auth-profiles.json under OPENMEHDI_AGENT_DIR when set", async () => {
    const env = await setupAuthTestEnv("openmehdi-oauth-");
...
describe("setMinimaxApiKey", () => {
  ...
  it("writes to OPENMEHDI_AGENT_DIR when set", async () => {
    const env = await setupAuthTestEnv("openmehdi-minimax-", { agentSubdir: "custom-agent" });
    lifecycle.setStateDir(env.stateDir);

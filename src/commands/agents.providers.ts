...
function resolveDefaultAccountId(cfg: OpenMehdiConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenMehdiConfig): boolean {
...
export function summarizeBindings(cfg: OpenMehdiConfig, bindings: AgentBinding[]): string[] {

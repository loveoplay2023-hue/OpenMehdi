...
type PromptDefaultModelResult = { model?: string; config?: OpenMehdiConfig };
...
function resolveConfiguredModelRaw(cfg: OpenMehdiConfig): string {
...
function resolveConfiguredModelKeys(cfg: OpenMehdiConfig): string[] {
...
export function applyPrimaryModel(cfg: OpenMehdiConfig, model: string): OpenMehdiConfig {
...
export function applyModelAllowlist(cfg: OpenMehdiConfig, models: string[]): OpenMehdiConfig {
  const defaults = cfg.agents?.defaults;

...
function mergeSignalAccountConfig(cfg: OpenMehdiConfig, accountId: string): SignalAccountConfig {
...
export function listEnabledSignalAccounts(cfg: OpenMehdiConfig): ResolvedSignalAccount[] {

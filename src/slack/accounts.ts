...
function mergeSlackAccountConfig(cfg: OpenMehdiConfig, accountId: string): SlackAccountConfig {
...
export function listEnabledSlackAccounts(cfg: OpenMehdiConfig): ResolvedSlackAccount[] {

...
// Prefix for OpenMehdi-generated action IDs to scope our handler
const OPENMEHDI_ACTION_PREFIX = "openmehdi:";
...
export function registerSlackInteractionEvents(params: { ctx: SlackMonitorContext }) {
  ...
  // Handle OpenMehdi modal submissions with callback_ids scoped by our prefix.
  ctx.app.view(
    new RegExp(`^${OPENMEHDI_ACTION_PREFIX}`),

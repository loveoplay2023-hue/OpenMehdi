...
export type { OpenMehdiConfig } from "../config/config.js";
/** @deprecated Use OpenMehdiConfig instead */
export type { OpenMehdiConfig as ClawdbotConfig } from "../config/config.js";

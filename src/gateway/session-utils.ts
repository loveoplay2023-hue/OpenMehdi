...
import { type OpenMehdiConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: OpenMehdiConfig): string[] {
...
export function listAgentsForGateway(cfg: OpenMehdiConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: OpenMehdiConfig): string {
...
function resolveSessionStoreAgentId(cfg: OpenMehdiConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: OpenMehdiConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: OpenMehdiConfig): GatewaySessionsDefaults {

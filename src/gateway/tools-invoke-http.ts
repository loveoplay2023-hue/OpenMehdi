...
import { createOpenMehdiTools } from "../agents/openmehdi-tools.js";
import {
...
export async function handleToolsInvokeHttpRequest(
  ...
  const messageChannel = normalizeMessageChannel(
    getHeader(req, "x-openmehdi-message-channel") ?? "",
  );
  const accountId = getHeader(req, "x-openmehdi-account-id")?.trim() || undefined;
  ...
  const allTools = createOpenMehdiTools({

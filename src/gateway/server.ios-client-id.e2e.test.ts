...
beforeAll(async () => {
  previousToken = process.env.OPENMEHDI_GATEWAY_TOKEN;
  process.env.OPENMEHDI_GATEWAY_TOKEN = "test-gateway-token-1234567890";
...
test.each([
  { clientId: "openmehdi-ios", platform: "ios" },
  { clientId: "openmehdi-android", platform: "android" },

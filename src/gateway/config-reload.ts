...
import type { OpenMehdiConfig, ConfigFileSnapshot, GatewayReloadMode } from "../config/config.js";
...
export function resolveGatewayReloadSettings(cfg: OpenMehdiConfig): GatewayReloadSettings {
...
export function startGatewayConfigReloader(opts: {
  initialConfig: OpenMehdiConfig;
  readSnapshot: () => Promise<ConfigFileSnapshot>;
  onHotReload: (plan: GatewayReloadPlan, nextConfig: OpenMehdiConfig) => Promise<void>;
  onRestart: (plan: GatewayReloadPlan, nextConfig: OpenMehdiConfig) => void;
  log: {

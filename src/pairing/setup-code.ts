...
function resolveGatewayPort(cfg: OpenMehdiConfig, env: NodeJS.ProcessEnv): number {
...
function resolveAuth(cfg: OpenMehdiConfig, env: NodeJS.ProcessEnv): ResolveAuthResult {
  ...
  const password =
    env.OPENMEHDI_GATEWAY_PASSWORD?.trim() ||

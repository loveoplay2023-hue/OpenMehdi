import type { ChannelOnboardingAdapter, OpenMehdiConfig, WizardPrompter } from "openmehdi/plugin-sdk";
...
async function noteMattermostSetup(prompter: WizardPrompter): Promise<void> {
  await prompter.note(
    [
      ...
      "Docs: https://docs.openmehdi.ai/channels/mattermost",
    ].join("\n"),

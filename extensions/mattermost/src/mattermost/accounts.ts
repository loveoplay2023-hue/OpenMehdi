...
export function listMattermostAccountIds(cfg: OpenMehdiConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: OpenMehdiConfig): string {
...
export function listEnabledMattermostAccounts(cfg: OpenMehdiConfig): ResolvedMattermostAccount[] {

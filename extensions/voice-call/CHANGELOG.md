...
- Version alignment with core OpenMehdi release numbers.
...
- First public release of the @openmehdi/voice-call plugin.
...
- CLI: `openmehdi voicecall` commands (call/start/continue/speak/end/status/tail/expose).

...
Nostr DM channel plugin for OpenMehdi using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to OpenMehdi. It enables your bot to:
...
# Configure openmehdi to use local relay

...
export function listGoogleChatAccountIds(cfg: OpenMehdiConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OpenMehdiConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OpenMehdiConfig): ResolvedGoogleChatAccount[] {

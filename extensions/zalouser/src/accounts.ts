...
export function listZalouserAccountIds(cfg: OpenMehdiConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OpenMehdiConfig): string {
...
function mergeZalouserAccountConfig(cfg: OpenMehdiConfig, accountId: string): ZalouserAccountConfig {

...
This directory contains the **BlueBubbles external channel plugin** for OpenMehdi.
...
- Route into core reply pipeline via the plugin runtime (`api.runtime`) and `openmehdi/plugin-sdk` helpers.

...
import { resolveChannelMediaMaxBytes, type OpenMehdiConfig } from "openmehdi/plugin-sdk";
...
function resolveMediaLocalRoots(params: { cfg: OpenMehdiConfig; accountId?: string }): string[] {

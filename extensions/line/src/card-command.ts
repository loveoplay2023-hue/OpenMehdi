import type { LineChannelData, OpenMehdiPluginApi, ReplyPayload } from "openmehdi/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: OpenMehdiPluginApi): void {
  api.registerCommand({
    name: "card",

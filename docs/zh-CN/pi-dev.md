...
本指南总结了在 OpenMehdi 中开发 Pi 集成的合理工作流程。
...
状态存储在 OpenMehdi 状态目录下。默认为 `~/.openmehdi`。如果设置了 `OPENMEHDI_STATE_DIR`，则使用该目录。
...
- https://docs.openmehdi.ai/testing
- https://docs.openmehdi.ai/start/getting-started

...
- 生成的 Swift 模型：`apps/macos/Sources/OpenMehdiProtocol/GatewayModels.swift`
...
- https://raw.githubusercontent.com/openmehdi/openmehdi/main/dist/protocol.schema.json

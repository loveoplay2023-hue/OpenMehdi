...
summary: "`openmehdi skills` 的 CLI 参考（列出/信息/检查）和 skill 资格"
title: skills
x-i18n:
...
```bash
openmehdi skills list
openmehdi skills list --eligible
openmehdi skills info <name>
openmehdi skills check
```

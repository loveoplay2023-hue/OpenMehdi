...
read_when:
  ...
  - Wiring external systems into OpenMehdi
title: "Webhooks"
---
...
- `hooks.transformsDir` + `transform.module` loads a JS/TS module for custom logic.
  - `hooks.transformsDir` (if set) must stay within the transforms root under your OpenMehdi config directory (typically `~/.openmehdi/hooks/transforms`).
...
- `openmehdi webhooks gmail setup` writes `hooks.gmail` config for `openmehdi webhooks gmail run`.

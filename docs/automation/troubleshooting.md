...
openmehdi system heartbeat last
openmehdi logs --follow
openmehdi config get agents.defaults.heartbeat
openmehdi channels status --probe
```
...
```bash
openmehdi config get agents.defaults.heartbeat.activeHours
openmehdi config get agents.defaults.heartbeat.activeHours.timezone
openmehdi config get agents.defaults.userTimezone || echo "agents.defaults.userTimezone not set"
openmehdi cron list
openmehdi logs --follow
```

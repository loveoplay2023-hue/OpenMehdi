...
- Same path: run the app from a fixed location (for OpenMehdi, `dist/OpenMehdi.app`).
...
Workaround: move files into the OpenMehdi workspace (`~/.openmehdi/workspace`) if you want to avoid per-folder grants.

...
- Install via CLI: `openmehdi plugins install @openmehdi/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `openmehdi plugins install ./extensions/zalo`
   - From npm (if published): `openmehdi plugins install @openmehdi/zalo`
...
- Approve via:
  - `openmehdi pairing list zalo`
  - `openmehdi pairing approve zalo <CODE>`
...
- Example: `openmehdi message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `openmehdi channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `openmehdi logs --follow`

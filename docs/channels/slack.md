...
```
  ...
  <Tab title="HTTP Events API mode">
    <Steps>
      ...
      <Step title="Configure OpenMehdi HTTP mode">
...
<Tabs>
  <Tab title="DM policy">
    ...
    Pairing in DMs uses `openmehdi pairing approve slack <code>`.
...
OpenMehdi supports Slack native text streaming via the Agents and AI Apps API.
...
- If streaming fails mid-reply, OpenMehdi falls back to normal delivery for remaining payloads.

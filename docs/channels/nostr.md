...
read_when:
  - You want OpenMehdi to receive DMs via Nostr
...
Nostr is a decentralized protocol for social networking. This channel enables OpenMehdi to receive and respond to encrypted direct messages (DMs) via NIP-04.

## Install (on demand)

### Onboarding (recommended)

- The onboarding wizard (`openmehdi onboard`) and `openmehdi channels add` list optional channel plugins.
...
```bash
openmehdi plugins install @openmehdi/nostr
```

Use a local checkout (dev workflows):

```bash
openmehdi plugins install --link <path-to-openmehdi>/extensions/nostr
```
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "openmehdi",
        "displayName": "OpenMehdi",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "openmehdi@example.com",
        "lud16": "openmehdi@example.com"
      }
    }
  }
}

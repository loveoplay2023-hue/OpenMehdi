...
read_when:
  - You are building a OpenMehdi plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (openmehdi.plugin.json)

Every plugin **must** ship a `openmehdi.plugin.json` file in the **plugin root**.
OpenMehdi uses this manifest to validate configuration **without executing plugin

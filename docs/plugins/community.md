...
read_when:
  - You want to publish a third-party OpenMehdi plugin
...
This page tracks high-quality **community-maintained plugins** for OpenMehdi.

We accept PRs that add community plugins here when they meet the quality bar.

## Required for listing

- Plugin package is published on npmjs (installable via `openmehdi plugins install <npm-spec>`).
...
- **Plugin Name** — short description
  ...
  install: `openmehdi plugins install @scope/package`

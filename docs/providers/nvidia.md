---
summary: "Use NVIDIA's OpenAI-compatible API in OpenMehdi"
read_when:
  - You want to use NVIDIA models in OpenMehdi
...
openmehdi onboard --auth-choice skip
openmehdi models set nvidia/nvidia/llama-3.1-nemotron-70b-instruct
```

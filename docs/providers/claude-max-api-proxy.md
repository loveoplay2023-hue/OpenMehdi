...
You can point OpenMehdi at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OpenMehdi
...
- [Anthropic provider](/providers/anthropic) - Native OpenMehdi integration with Claude setup-token or API keys

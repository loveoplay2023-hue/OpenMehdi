---
summary: "Use Qwen OAuth (free tier) in OpenMehdi"
read_when:
  - You want to use Qwen with OpenMehdi
...
If you already logged in with the Qwen Code CLI, OpenMehdi will sync credentials

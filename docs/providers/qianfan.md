---
summary: "Use Qianfan's unified API to access many models in OpenMehdi"
read_when:
...
3. OpenMehdi installed on your system
...
4. Copy the API key for use with OpenMehdi

## CLI setup

```bash
openmehdi onboard --auth-choice qianfan-api-key
```

## Related Documentation

- [OpenMehdi Configuration](/gateway/configuration)

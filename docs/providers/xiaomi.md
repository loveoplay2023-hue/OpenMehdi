---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenMehdi"
read_when:
  - You want Xiaomi MiMo models in OpenMehdi
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenMehdi uses

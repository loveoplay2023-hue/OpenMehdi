---
summary: "Overview of OpenMehdi onboarding options and flows"
read_when:
...
OpenMehdi supports multiple onboarding paths depending on where the Gateway runs
...
- [`openmehdi onboard` command](/cli/onboard)

## macOS app onboarding

Use the OpenMehdi app when you want a fully guided setup on macOS. Docs:

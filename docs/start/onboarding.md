---
summary: "First-run onboarding flow for OpenMehdi (macOS app)"
read_when:
...
<Frame caption="Choose what permissions do you want to give OpenMehdi">
...
<Step title="CLI">
  ...
  The app can install the global `openmehdi` CLI via npm/pnpm so terminal

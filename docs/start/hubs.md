---
summary: "Hubs that link to every OpenMehdi doc"
read_when:
...
<Note>
If you are new to OpenMehdi, start with [Getting Started](/start/getting-started).
</Note>
...
- [OpenMehdi assistant](/start/openmehdi)

...
This guide summarizes a sane workflow for working on the pi integration in OpenMehdi.
...
- Trigger the agent directly:
  - `pnpm openmehdi agent --message "Hello" --thinking low`
...
State lives under the OpenMehdi state directory. Default is `~/.openmehdi`. If `OPENMEHDI_STATE_DIR` is set, use that directory instead.

To reset everything:

- `openmehdi.json` for config
...
- [https://docs.openmehdi.ai/testing](https://docs.openmehdi.ai/testing)
- [https://docs.openmehdi.ai/start/getting-started](https://docs.openmehdi.ai/start/getting-started)

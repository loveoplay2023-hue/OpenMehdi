...
- `fix: <summary> (openmehdi#<PR>) thanks @<author>`

```sh
commit_msg="fix: <summary> (openmehdi#$pr_number) thanks @$contrib"
...
echo "$subject" | rg -q "openmehdi#$pr_number" || { echo "ERROR: commit subject missing openmehdi#$pr_number"; exit 1; }
